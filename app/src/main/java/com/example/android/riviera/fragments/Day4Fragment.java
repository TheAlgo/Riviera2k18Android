...
public class Day4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view1 = inflater.inflate(R.layout.fragment_day4, container, false);
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                InputStream is = context.getAssets().open("day4.json");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                recyclerView2 = (RecyclerView)v.findViewById(R.id.recycler_data4);
